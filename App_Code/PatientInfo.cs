...
public class PatientInfo
{
    ...
    public PatientInfo GetSpecificPatientByEmail(string enteredEmail)
    {
        ...
        //query string
        string queryStr = "SELECT email,given_Name,family_Name from PatientInfo Where email=@Email"; //changed by sean 9jan
        ...
        {
            //store the data into object
            string email = dr["email"].ToString(); //changed by sean 9jan
            string given_Name = dr["given_Name"].ToString();
            string family_Name = dr["family_Name"].ToString();

            x = new PatientInfo(email, given_Name, family_Name);
        }
    ...
    public PatientInfo GetSpecificPatient(string enteredEmail)
    {
        PatientInfo x = null;
