...
public partial class Nurse_PatientManagement_List_EditPatient : System.Web.UI.Page
{
    ...
    protected void SaveBtn_Click(object sender, EventArgs e)
    {
        ...
        if (result > 0)
        {
            Response.Write("<script>alert('Account updated');location.href='/Nurse/PatientManagement_Details.aspx?ID="+id+"';</script>");
        }
    }
}